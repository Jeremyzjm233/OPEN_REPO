# airflow-aws-ecs
Repositry for installing and deploying airflow on ECS, including local docker compose
...
* setup these env variables in your .zshrc or .bashrc, or in your the terminal session that you are going to use
  ...
  export AWS_DEFAULT_REGION=ap-southeast-2 # it's the default region that needs to be setup also in infrastructure/config.tf
  </pre>
...
Access airflow webserver on [localhost:8080](http://localhost:8080).
